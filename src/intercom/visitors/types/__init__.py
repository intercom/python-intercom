...
_dynamic_imports: typing.Dict[str, str] = {
    "ConvertVisitorRequestUser": ".convert_visitor_request_user",
    "ConvertVisitorRequestVisitor": ".convert_visitor_request_visitor",
    "UserWithId": ".user_with_id",
    "UserWithUserId": ".user_with_user_id",
    "VisitorWithEmail": ".visitor_with_email",
    "VisitorWithId": ".visitor_with_id",
    "VisitorWithUserId": ".visitor_with_user_id",
}
