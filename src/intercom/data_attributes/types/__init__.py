...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "DataAttributeDataType": ".data_attribute_data_type",
    "DataAttributeModel": ".data_attribute_model",
    "DataAttributesListRequestModel": ".data_attributes_list_request_model",
}
