...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "SubscriptionTypeConsentType": ".subscription_type_consent_type",
    "SubscriptionTypeContentTypesItem": ".subscription_type_content_types_item",
    "SubscriptionTypeState": ".subscription_type_state",
}
