...
class RawAwayStatusReasonsClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def list_away_status_reasons(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[typing.List[AwayStatusReason]]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=typing.List[AwayStatusReason],  # type: ignore
...
class AsyncRawAwayStatusReasonsClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def list_away_status_reasons(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[typing.List[AwayStatusReason]]:
        """
        Returns a list of all away status reasons configured for the workspace, including deleted ones.
