...
_dynamic_imports: typing.Dict[str, str] = {
    "CompaniesRetrieveResponse": ".companies_retrieve_response",
    "CompaniesRetrieveResponse_Company": ".companies_retrieve_response",
    "CompaniesRetrieveResponse_List": ".companies_retrieve_response",
    "Company": ".company",
