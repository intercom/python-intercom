...
class CompaniesClient:
    ...
    def delete(
        ...
        """
        _response = self._raw_client.delete(company_id, request_options=request_options)
        return _response.data
    ...
    def list_attached_segments(
        ...
        """
        _response = self._raw_client.list_attached_segments(company_id, request_options=request_options)
        return _response.data
    ...
    def list(
        ...
        *,
        ...
        for page in response.iter_pages():
            yield page
        """
        return self._raw_client.list(page=page, per_page=per_page, order=order, request_options=request_options)
    ...
    def detach_contact(
        ...
        """
        _response = self._raw_client.detach_contact(contact_id, company_id, request_options=request_options)
        return _response.data
...
class AsyncCompaniesClient:
    ...
    async def delete(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.delete(company_id, request_options=request_options)
        return _response.data
    ...
    async def list_attached_contacts(
        ...
        *,
        ...
        async def main() -> None:
            await client.companies.list_attached_contacts(
                company_id="5f4d3c1c-7b1b-4d7d-a97e-6095715c6632",
            )
    ...
    async def list_attached_segments(
        ...
        async def main() -> None:
            await client.companies.list_attached_segments(
                company_id="5f4d3c1c-7b1b-4d7d-a97e-6095715c6632",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list_attached_segments(company_id, request_options=request_options)
        return _response.data
    ...
    async def list(
        ...
        *,
        ...
        asyncio.run(main())
        """
        return await self._raw_client.list(page=page, per_page=per_page, order=order, request_options=request_options)
    ...
    async def scroll(
        ...
        async def main() -> None:
            response = await client.companies.scroll()
            async for item in response:
                yield item
    ...
    async def attach_contact(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.attach_contact(
            contact_id, company_id=company_id, request_options=request_options
        )
        return _response.data
    ...
    async def detach_contact(
        ...
        async def main() -> None:
            await client.companies.detach_contact(
                contact_id="58a430d35458202d41b1e65b",
                company_id="58a430d35458202d41b1e65b",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.detach_contact(contact_id, company_id, request_options=request_options)
        return _response.data
