...
class RawCallsClient:
    ...
    def show_call(self, call_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Call]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"calls/{jsonable_encoder(call_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def show_call_recording(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"calls/{jsonable_encoder(call_id)}/recording",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def show_call_transcript(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"calls/{jsonable_encoder(call_id)}/transcript",
            method="GET",
            request_options=request_options,
        )
        try:
