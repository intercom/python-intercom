...
from typing import Any, Dict, Union, Iterable, Optional, cast, overload
...
class ConversationsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> SyncCursorPagination[ConversationListResponse]:
        """
        ...
        return self._get_api_list(
            "/conversations",
            page=SyncCursorPagination[ConversationListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def search(
        ...
        *,
        ...
        pagination: Optional[shared_params.StartingAfterPaging] | NotGiven = NOT_GIVEN,
        intercom_version: Literal[
            "1.0",
            "1.1",
            "1.2",
...
class AsyncConversationsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[ConversationListResponse, AsyncCursorPagination[ConversationListResponse]]:
        """
        You can fetch a list of all conversations.
        ...
        return self._get_api_list(
            "/conversations",
            page=AsyncCursorPagination[ConversationListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
