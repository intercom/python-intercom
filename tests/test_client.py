...
class TestIntercom:
    client = Intercom(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(IntercomError):
            client2 = Intercom(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(INTERCOM_BASE_URL="http://localhost:5000/from/env"):
            client = Intercom(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(INTERCOM_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                Intercom(bearer_token=bearer_token, _strict_response_validation=True, environment="production")
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Intercom(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
...
class TestAsyncIntercom:
    client = AsyncIntercom(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(IntercomError):
            client2 = AsyncIntercom(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(INTERCOM_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncIntercom(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(INTERCOM_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncIntercom(bearer_token=bearer_token, _strict_response_validation=True, environment="production")
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncIntercom(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
