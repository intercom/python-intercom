...
class TestAsyncTags:
    ...
    async def test_method_create(self, client: AsyncIntercom) -> None:
        tag = await client.tickets.tags.create(
            "string",
            id="string",
            admin_id="string",
        )
    ...
    async def test_raw_response_create(self, client: AsyncIntercom) -> None:
        response = await client.tickets.tags.with_raw_response.create(
            "string",
            id="string",
            admin_id="string",
        )
    ...
    async def test_method_remove(self, client: AsyncIntercom) -> None:
        tag = await client.tickets.tags.remove(
            "string",
            ticket_id="64619700005694",
            admin_id="string",
        )
    ...
    async def test_raw_response_remove(self, client: AsyncIntercom) -> None:
        response = await client.tickets.tags.with_raw_response.remove(
            "string",
            ticket_id="64619700005694",
            admin_id="string",
        )
